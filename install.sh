...
echo ""
echo "Done. Skills available: /pipeline-init, /pipeline-next, /pipeline-run, /pipeline-ship, /pipeline-dev, /pipeline-retro, /pipeline-roadmap-audit, /pipeline-strategy, /pipeline-drain, /pipeline-cycle, pipeline-shared (reference)"
